  ...
  return (
    <section className="card-surface p-4 sm:p-5 border-l-4 border-orange-500/60 print:break-inside-avoid print:border-0 print:p-0 print:bg-transparent">
      <div className="flex items-center justify-between gap-3 flex-wrap mb-3">
        ...
        {canEdit && dirty && (
          <Button
            ...
            disabled={saving}
            size="sm"
            className="gold-surface gap-2 print:hidden"
          >
      ...
      <div className="hidden print:block">
        <PrintDiagram
          title="Left side"
          marks={marks.filter((m) => normView(m.view) === "left")}
          view="left"
        />
        <PrintDiagram
          title="Right side"
          marks={marks.filter((m) => normView(m.view) === "right")}
          view="right"
        />
        <PrintDiagram
          title="Top view"
          marks={marks.filter((m) => normView(m.view) === "top")}
          view="top"
        />

        <div style={{ marginTop: 10 }}>
          <div
            style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: 1 }}
          >
