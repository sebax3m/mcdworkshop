...
const RULES: Record<string, Rule[]> = {
  yamaha: [
    {
      ...
      spec: {
        intake: [0.1, 0.15],
        exhaust: [0.22, 0.27],
        source: "Yamaha MT-07 / Ténéré 700 (CP2)",
      },
    },
    {
      match: (m) => /mt[- ]?09|tracer ?9|xsr ?900|niken/i.test(m),
      spec: { intake: [0.11, 0.2], exhaust: [0.21, 0.3], source: "Yamaha MT-09 / Tracer 9 (CP3)" },
    },
    {
      match: (m) => /mt[- ]?10|r ?1\b|fz ?10/i.test(m),
      spec: { intake: [0.11, 0.2], exhaust: [0.21, 0.25], source: "Yamaha YZF-R1 / MT-10" },
    },
    {
      match: (m) => /r ?6\b|yzf[- ]?r6/i.test(m),
      spec: { intake: [0.13, 0.2], exhaust: [0.2, 0.3], source: "Yamaha YZF-R6" },
    },
    {
      match: (m) => /r ?3\b|mt[- ]?03|yzf[- ]?r3/i.test(m),
      spec: { intake: [0.1, 0.15], exhaust: [0.22, 0.27], source: "Yamaha YZF-R3 / MT-03" },
    },
    {
      match: () => true,
      spec: {
        intake: [0.11, 0.2],
        exhaust: [0.21, 0.3],
        source: "Yamaha (typical 4-stroke)",
        generic: true,
      },
    },
  ],
  honda: [
    ...
    },
    {
      ...
      spec: { intake: [0.2, 0.24], exhaust: [0.26, 0.3], source: "Honda CRF1000/1100 Africa Twin" },
    },
    {
      ...
      spec: {
        intake: [0.14, 0.18],
        exhaust: [0.23, 0.27],
        source: "Honda CB500/CBR500 parallel-twin",
      },
    },
    {
    ...
    },
    {
      ...
      spec: { intake: [0.16, 0.2], exhaust: [0.16, 0.2], source: "Honda Grom / Monkey 125" },
    },
    {
      match: () => true,
      spec: {
  ...
  kawasaki: [
    ...
    },
    {
      ...
      spec: { intake: [0.1, 0.2], exhaust: [0.15, 0.25], source: "Kawasaki KLR650 / KLX" },
    },
    {
      match: () => true,
      spec: {
        intake: [0.15, 0.24],
        exhaust: [0.22, 0.31],
        source: "Kawasaki (typical 4-stroke)",
        generic: true,
      },
    },
  ],
  suzuki: [
    {
      ...
      spec: { intake: [0.1, 0.2], exhaust: [0.2, 0.3], source: "Suzuki GSX-R1000" },
    },
    {
      match: (m) => /gsx[- ]?r ?750|gsx[- ]?r ?600/i.test(m),
      spec: { intake: [0.1, 0.2], exhaust: [0.2, 0.3], source: "Suzuki GSX-R600/750" },
    },
    {
      match: (m) => /sv ?650|gladius|v[- ]?strom ?650/i.test(m),
      spec: { intake: [0.1, 0.2], exhaust: [0.2, 0.3], source: "Suzuki SV650 / V-Strom 650" },
    },
    {
      ...
      spec: {
        intake: [0.1, 0.2],
        exhaust: [0.2, 0.3],
        source: "Suzuki 1000/1050cc V-twin & inline-4",
      },
    },
    {
      match: () => true,
      spec: {
        intake: [0.1, 0.2],
        exhaust: [0.2, 0.3],
        source: "Suzuki (typical 4-stroke)",
        generic: true,
      },
    },
  ],
  ducati: [
    {
      ...
      spec: {
        intake: [0.1, 0.15],
        exhaust: [0.2, 0.25],
        source: "Ducati Desmosedici Stradale V4 (opening)",
    ...
    },
    {
      ...
      spec: {
        intake: [0.1, 0.15],
        exhaust: [0.2, 0.25],
        source: "Ducati Testastretta L-twin (opening)",
        note: "Desmodromic — also check closing clearance per manual.",
      },
    },
    {
  ...
  bmw: [
    {
      ...
      spec: { intake: [0.13, 0.18], exhaust: [0.25, 0.3], source: "BMW S1000RR / S1000R" },
    },
    {
      ...
      spec: {
        intake: [0.15, 0.2],
        exhaust: [0.3, 0.35],
        source: "BMW R 1200/1250/1300 boxer (ShiftCam)",
      },
    },
    {
      match: (m) => /f ?850|f ?900|f ?750/i.test(m),
      spec: { intake: [0.13, 0.18], exhaust: [0.25, 0.3], source: "BMW F 750/850/900" },
    },
    {
      match: () => true,
      spec: { intake: [0.15, 0.2], exhaust: [0.3, 0.35], source: "BMW (typical)", generic: true },
    },
  ],
  ktm: [
    {
      match: (m) => /390|rc ?390|duke ?390|adventure ?390/i.test(m),
      spec: { intake: [0.1, 0.15], exhaust: [0.2, 0.25], source: "KTM 390 LC4c" },
    },
    {
      match: (m) => /690|smc ?r|enduro ?r/i.test(m),
      spec: { intake: [0.1, 0.15], exhaust: [0.2, 0.25], source: "KTM 690 LC4" },
    },
    {
      match: (m) => /790|890/i.test(m),
      spec: { intake: [0.1, 0.15], exhaust: [0.2, 0.25], source: "KTM 790/890 LC8c" },
    },
    {
      match: (m) => /1190|1290|super ?duke|super ?adventure/i.test(m),
      spec: { intake: [0.1, 0.15], exhaust: [0.2, 0.25], source: "KTM 1190/1290 LC8 V-twin" },
    },
    {
      match: () => true,
      spec: {
  ...
  triumph: [
    {
      match: (m) =>
        /street ?triple|daytona ?675|daytona ?765|trident ?660|tiger ?660|speed ?triple/i.test(m),
      spec: {
        intake: [0.1, 0.2],
        exhaust: [0.25, 0.35],
        source: "Triumph 660/675/765/1050/1200 triple",
      },
    },
    {
      ...
      spec: {
        intake: [0.1, 0.15],
        exhaust: [0.15, 0.25],
        source: "Triumph Bonneville parallel-twin (HT)",
      },
    },
    {
      match: () => true,
  ...
  aprilia: [
    {
      ...
      spec: { intake: [0.13, 0.2], exhaust: [0.3, 0.37], source: "Aprilia RSV4 / Tuono V4" },
    },
    {
      match: () => true,
      spec: {
  ...
  harley: [
    {
      ...
      spec: {
        intake: [0.0, 0.0],
        exhaust: [0.0, 0.0],
        source: "Harley-Davidson (hydraulic lifters)",
        generic: true,
