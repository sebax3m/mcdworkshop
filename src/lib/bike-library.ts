...
export const BIKE_MAKES: Record<string, string[]> = {
  ...
  Aprilia: ["RS 125", "RS 660", "RSV4", "Tuono 660", "Tuono V4", "Tuareg 660", "SR GT"],
  Husqvarna: [
    "Svartpilen 125",
    "Svartpilen 401",
    "Svartpilen 701",
  ...
  "Zero Motorcycles": ["S", "SR", "SR/F", "SR/S", "FX", "FXE", "DS", "DSR", "DSR/X"],
  Vespa: [
    "Primavera 50",
    "Primavera 125",
    "Primavera 150",
  ...
  Piaggio: ["Liberty 150", "Beverly 300", "Beverly 400", "MP3 400", "MP3 530"],
};
